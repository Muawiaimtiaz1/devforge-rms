...
export default function DashboardMetrics({ data }) {
  return <section className="dashboard-metrics">
    <article className="metric-card emerald"><span>Tips Collected</span><strong>Rs. {money(data.totalTipsCollected)}</strong><small>Selected date period · all shop shifts</small></article>
