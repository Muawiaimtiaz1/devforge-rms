...
function money(value) {
  return new Intl.NumberFormat('en-PK', { style: 'currency', currency: getShopCurrency(), maximumFractionDigits: 2 }).format(Number(value || 0))
}
