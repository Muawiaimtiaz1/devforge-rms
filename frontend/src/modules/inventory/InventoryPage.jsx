...
const StockProductFormModal = lazy(() => import('./components/StockProductFormModal'))
...
export default function InventoryPage() {
  ...
  async function productSaved(message) { setModal(null); notify(message); await inventory.refresh() }
