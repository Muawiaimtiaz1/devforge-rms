...
function renderShiftReceiptPage(details, options = {}) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><title>Shift ${shift.id} Z Report</title><style>
    @page{size:80mm auto;margin:0}*{box-sizing:border-box}body{margin:0;background:#fff;color:#000;font-family:'Courier New',monospace}.receipt{width:80mm;padding:4mm;font-size:11px;line-height:1.35}.center{text-align:center}.title{font-size:18px;font-weight:900}.subtitle{font-size:13px;font-weight:900;margin-top:2px}.rule{border-top:1px dashed #000;margin:7px 0}.heavy{border-top:2px solid #000}.row{display:flex;justify-content:space-between;gap:8px;padding:2px 0}.row span:first-child{flex:1}.row span:last-child{text-align:right;font-weight:700}.strong{font-size:13px;font-weight:900}.section{font-weight:900;text-align:center;margin:7px 0 3px}.result{border:2px solid #000;padding:7px;text-align:center;font-size:15px;font-weight:900;margin:8px 0}.note{white-space:pre-wrap;overflow-wrap:anywhere}.footer{text-align:center;font-size:9px;margin-top:10px}@media print{.receipt{width:100%}}
